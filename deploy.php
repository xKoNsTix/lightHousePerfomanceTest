...
set('repository','git@github.com:xKoNsTix/lightHousePerfomanceTest.git');
...
task('post-deploy', function () {
    ...
    run('sudo chown -R ben:www-data /var/www/frontend');
    run('sudo chmod -R u+rwx /var/www/frontend');
  });
